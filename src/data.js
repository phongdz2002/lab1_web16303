...
export const productList = [
    ...
    {
        id: 2,
        name: "10 bộ phim nổi tiếng Hollywood được lấy cảm hứng từ anime/manga Nhật Bản",
    ...
    {
        id: 3,
        name: "Lý do cửa hàng ăn của Sanji ''chỉ có khách nữ'' đã được hé lộ trong Shokugeki no Sanji, câu trả lời khiến fan phải sốc",
    ...
    {
        id: 4,
        name: "Cựu huyền thoại Liên Quân bức xúc khi mua sản phẩm đã bị “bóc hộp, phá tem” từ thương hiệu cực lớn",
    ...
    {
        id: 5,
        name: "22 lần Hollywood tìm được những diễn viên hoàn hảo để đóng phim live-action chuyển thể hoạt hình",
    ...
    {
        id: 6,
        name: "PUBG chính thức trở thành game miễn phí 0 đồng, tải thoải mải trên Steam",
